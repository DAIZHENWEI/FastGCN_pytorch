...
if __name__ == '__main__':
    ...
    """ Pick samples by laplacian norm"""
    ...
    if args.remove_degree_one:
        np.save(directory + 'GCN_accuracy_list_{}_laplacian_remove_degree_one_ratio{}.npy'.format(args.dataset, args.ratio), test_accs)
    else:
        np.save(directory + 'GCN_accuracy_list_{}_laplacian_ratio{}.npy'.format(args.dataset, args.ratio), test_accs)


    if args.remove_degree_one:
        np.save(directory + 'GCN_macro_f1_list_{}_laplacian_remove_degree_one_ratio{}.npy'.format(args.dataset, args.ratio), test_f1)
    else:
        np.save(directory + 'GCN_macro_f1_list_{}_laplacian_ratio{}.npy'.format(args.dataset, args.ratio), test_f1)