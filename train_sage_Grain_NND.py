...
if __name__ == '__main__':
    ...
    file = '../Grain/examples/sampled_nodes/GRAIN(NN-D)_select_{}_nodes{}.json'.format(args.dataset, num_sampled)
    ...
    if args.remove_degree_one:
        np.save(directory + 'GraphSage_accuracy_list_{}_GRAIN_NND_remove_degree_one_ratio{}.npy'.format(args.dataset, args.ratio), test_accs)
    else:
        np.save(directory + 'GraphSage_accuracy_list_{}_GRAIN_NND_ratio{}.npy'.format(args.dataset, args.ratio), test_accs)


    if args.remove_degree_one:
        np.save(directory + 'GraphSage_macro_f1_list_{}_GRAIN_NND_remove_degree_one_ratio{}.npy'.format(args.dataset, args.ratio), test_f1)
    else:
        np.save(directory + 'GraphSage_macro_f1_list_{}_GRAIN_NND_ratio{}.npy'.format(args.dataset, args.ratio), test_f1)