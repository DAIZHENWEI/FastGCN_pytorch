...
if __name__ == '__main__':
    ...
    np.save(directory + 'GraphSage_accuracy_list_{}_random_batch_at_scale_sample_method_{}_cold_start{}_redundancy{}_pretrain_ratio{}_ratio{}_total_ratio{}.npy'.format(args.dataset, 
                                                                                                            args.sample_method,
                                                                                                            args.cold_start,
                                                                                                            redundancy,
                                                                                                            args.pretrain_ratio,
    ...
    np.save(directory + 'GraphSage_macro_f1_{}_random_batch_at_scale_sample_method_{}_cold_start{}_redundancy{}_pretrain_ratio{}_ratio{}_total_ratio{}.npy'.format(args.dataset, 
                                                                                                            args.sample_method,
                                                                                                            args.cold_start,
                                                                                                            redundancy,
                                                                                                            args.pretrain_ratio,
