...
if __name__ == '__main__':
    ...
    np.save(directory + 'GraphSage_accuracy_list_{}_active_random_uncertain_increment_pretrain{}_epochs{}_pretrain_ratio{}_ratio{}_sample_freq{}.npy'.format(args.dataset, 
                                                                                                        args.pre_train_epochs, 
                                                                                                        args.epochs,
                                                                                                        args.pretrain_ratio,
                                                                                                        args.ratio,
    ...
    np.save(directory + 'Sample_count_list_{}_active_random_uncertain_increment_pretrain{}_epochs{}_pretrain_ratio{}_ratio{}_sample_freq{}.npy'.format(args.dataset, 
                                                                                                        args.pre_train_epochs, 
                                                                                                        args.epochs,
                                                                                                        args.pretrain_ratio,
                                                                                                        args.ratio,
