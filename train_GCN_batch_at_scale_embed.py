...
from utils_sage import dataloader
...
class GCN_Model:
    ...
    def run(self, epochs=None, return_pred=False, return_embed=False):
        # Training loop
        avg = 0
        iter_tput = []
        test_acc_list = []
...
if __name__ == '__main__':
    ...
    np.save(directory + 'GCN_accuracy_list_{}_batch_at_scale_embed_sample_method_{}_cold_start{}_redundancy{}_pretrain_ratio{}_ratio{}_total_ratio{}.npy'.format(args.dataset, 
                                                                                                            args.sample_method,
                                                                                                            args.cold_start,
                                                                                                            redundancy,
                                                                                                            args.pretrain_ratio,
    ...
    np.save(directory + 'GCN_macro_f1_{}_batch_at_scale_sample_embed_method_{}_cold_start{}_redundancy{}_pretrain_ratio{}_ratio{}_total_ratio{}.npy'.format(args.dataset, 
                                                                                                            args.sample_method,
                                                                                                            args.cold_start,
                                                                                                            redundancy,
                                                                                                            args.pretrain_ratio,
