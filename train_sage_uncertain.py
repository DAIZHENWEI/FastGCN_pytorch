...
if __name__ == '__main__':
    ...
    for _ in range(0, (args.epochs - args.pre_train_epochs) // sample_freq):
        ...
        train_ind_sampled = train_index_sort[:num_sampled]
        data = train_ind_sampled, valid_index, test_index, in_feats, labels, n_classes, feats, graph
    ...
    np.save(directory + 'GraphSage_accuracy_list_{}_active_random_uncertain_epochs{}_pretrain{}_ratio{}_sample_freq{}.npy'.format(args.dataset, 
                                                                                                        args.epochs,
                                                                                                        args.pre_train_epochs, 
                                                                                                        args.ratio,
