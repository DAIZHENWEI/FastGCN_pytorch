...
from utils_sage import load_data, load_pubmed, load_ogbn_arxiv, margin_score, dataloader
...
if __name__ == '__main__':
    ...
    file = '../Grain/examples/sampled_nodes/GRAIN(NN-D)_select_{}_nodes{}.json'.format(args.dataset, n_sampled)
    ...
    if epochs < args.epochs and not args.cold_start:
