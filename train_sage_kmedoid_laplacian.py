...
if __name__ == '__main__':
    ...
    np.save(directory + 'GraphSage_accuracy_list_{}_Kmedoid_laplacian_ncluster{}_AggregateLayer{}_ratio{}.npy'.format(args.dataset, 
                                                                                                            n_cluster,
                                                                                                            args.prop_layers, 
                                                                                                            args.ratio), test_accs)

    np.save(directory + 'GraphSage_micro_f1_list_{}_Kmedoid_laplacian_ncluster{}_AggregateLayer{}_ratio{}.npy'.format(args.dataset, 
                                                                                                            n_cluster,
                                                                                                            args.prop_layers, 
                                                                                                            args.ratio), test_f1)
