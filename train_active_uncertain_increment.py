...
if __name__ == '__main__':
    ...
    np.save('./save/test_accuracy_{}_{}_active_laplacian_uncertain_increment_compround{}_pretrain{}_ratio{}.npy'.format(args.dataset, 
                                                                                                                args.model,
                                                                                                                args.comp_embed_epochs,
                                                                                                                args.pre_train_epochs, 
                                                                                                                args.pretrain_ratio), test_acc_list)

    np.save('./save/sample_count_{}_{}_active_laplacian_uncertain_increment_compround{}_pretrain{}_ratio{}.npy'.format(args.dataset, 
                                                                                                                args.model,
                                                                                                                args.comp_embed_epochs,
                                                                                                                args.pre_train_epochs, 
