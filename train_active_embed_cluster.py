...
if __name__ == '__main__':
    ...
    for epochs in range(0, (args.epochs - args.pre_train_epochs) // test_gap):
        ...
        train_loss, train_acc, train_time = train(extra_train_index,
                                                  y_train,
                                                  args.batchsize,
                                                  test_gap)
        test_loss, test_acc, test_time = test(test_adj,
    ...
    np.save('./save/test_accuracy_list_{}_{}_active_laplacian_embed_cluster_compround{}_pretrain{}_ratio{}.npy'.format(args.dataset, 
                                                                                                    args.model,
