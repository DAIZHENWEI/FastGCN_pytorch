...
if __name__ == '__main__':
    ...
    if args.remove_degree_one:
        np.save(directory + 'GraphSage_Shuffle_accuracy_list_{}_random_remove_degree_one_ratio{}.npy'.format(args.dataset, args.ratio), test_accs)
    else:
        np.save(directory + 'GraphSage_Shuffle_accuracy_list_{}_random_ratio{}.npy'.format(args.dataset, args.ratio), test_accs)


    if args.remove_degree_one:
        np.save(directory + 'GraphSage_Shuffle_macro_f1_list_{}_random_remove_degree_one_ratio{}.npy'.format(args.dataset, args.ratio), test_f1)
    else:
        np.save(directory + 'GraphSage_Shuffle_macro_f1_list_{}_random_ratio{}.npy'.format(args.dataset, args.ratio), test_f1)